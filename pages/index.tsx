  ...
  return (
    <>
      ...
      <div  id="main_div" className="              border-2 border-orange-400 min-h-screen flex flex-col justify-between px-2">
        ...
        <div id="averageheadenjoyer" className=" max-[520px]:h-10          border-2 border-white w-full h-14 ml-auto pt-4 pr-8 ">
          <div>
            {/* <ConnectButton
              accountStatus={{
                smallScreen: "avatar",
        ...
        <div className="    min-h-[calc(100vh-7.5rem)]          border-2 border-red-800 flex flex-col  justify-between px-20 max-[850px]:px-5 max-[520px]:px-3 ">


          <div className="flex  justify-center       border-2 border-blue-600 py-2 mx-10 max-[520px]:mx-0  ">
          ...
          <div className="              border-2 border-green-500 flex justify-center mx-12 max-[520px]:mx-2  ">
          ...
          <div className=" flex    border-2 border-red-400  justify-center mt-8">
          ...
          <div className="  max-[520px]:flex-col        border-2 border-red-500 flex  justify-center  my-8    ">
            
            <div className="flex gap-7        border-2 border-blue-500 justify-evenly  max-[730px]:justify-center max-[730px]:gap-8 max-[520px]:flex-col">
            <Link href="write-confession" className=" flex justify-center">
              <div className=" h-44 w-[21rem]  min-w-0  
               border-2 border-green-500  max-[730px]:self-center max-[520px]:h-16 max-[730px]:h-32 max-[730px]:w-[17rem]  max-[520px]:w-[18rem]  
              ...
              transition-all duration-100 active:bg-[#d2aa69]">
                <div className="flex justify-center min-[520px]:flex-col gap-3     2   border-2 border-red-500 items-center">
                  <div className="">
                  <div className=" text-5xl max-[730px]:text-3xl ">
                      <FontAwesomeIcon icon={faFeather as IconProp} size="1x" />
                    </div>
                  </div>
                  <div className="flex  text-center  h-min      border-2 border-blue-500 font-imfell text-[1.7rem] select-none max-[520px]:text-[1.3rem] max-[730px]:text-[1.4rem]">
                    write a confession
                  </div>
                </div>
              </div>
              ...
              <Link href="write-confession" className=" flex justify-center">
              <div className=" h-44 w-[21rem] min-w-0  
               border-2 border-green-500  max-[730px]:self-center max-[520px]:h-16 max-[730px]:h-32 max-[520px]:w-[18rem] max-[630px]:w-[13rem]   max-[730px]:w-[17rem]
              ...
              transition-all duration-100 active:bg-[#c5c5c5]">
                <div className="flex justify-center min-[520px]:flex-col gap-3    border-2 border-red-500 items-center">
                  <div className="">
                    <div className=" text-5xl max-[730px]:text-3xl">
                    <FontAwesomeIcon
                  ...
                  <div className="flex  text-center  h-min max-[730px]:text-[1.4rem]     border-2 border-blue-500 font-imfell text-[1.7rem] select-none max-[520px]:text-[1.3rem] ">
                    read a confession
                  </div>
                </div>
              </div>
          ...
          <div className=" flex max-[850px]:mx-2               border-2 border-red-400 justify-center ">
          ...
          <div id="averagefeetenjoyer" className="        border-2 border-green-500  text-3xl px-12 flex gap-5 pt-4 h-16 max-[850px]:pt-5 max-[850px]:px-4 ">
