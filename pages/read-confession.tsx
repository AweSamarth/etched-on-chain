  ...
  return (
    <>
      ...
      <div id="averageheadenjoyer" className=" max-[520px]:h-10                  border-white w-full h-14 ml-auto pt-4 pr-8 ">
        ...
        <div className="flex  justify-center             border-blue-600 py-2 mb-10 mx-10 max-[520px]:mx-0  ">
          ...
          mx-16  mb-2 self-center        border-green-500 flex-col  pt-4 pb-1">
          ...
          <div className=" gap-[0.4rem]  border-yellow-500 flex flex-col justify-center pb-4 mb-28  max-[520px]:mb-28">
